#Script that returns a trained DenseNet model on chest x-ray data for pneumonia detection
...
# DenseNet Takes 224x224 images as input, so we resize all of them
data_transforms = {
...
#Load the pre-trained model and set number of output features
...
eps=5 #specify number of epochs
