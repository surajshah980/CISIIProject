#Script that returns a trained VGGNet model on chest x-ray data for pneumonia detection
...
#Train on smaller dataset first --> other file will train on larger dataset
data_dir = 'data/MIMICS/'
TRAIN = 'trainM'
VAL = 'valM'

# VGG Takes 224x224 images as input, so we resize all of them
data_transforms = {
...
#In transfer learning, need to zero out the gradients
